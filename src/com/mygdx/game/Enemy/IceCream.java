...
public class IceCream implements Enemy {

    private final TextureRegion texture = GameScene.getSplitSpriteEnemy().getTexture(1, 3);
    ...
    public IceCream(/*Vector2 vector*/) {
    ...
    private void findPoint() {
        ...
        GameScene.getSliderLineEnemy().setCount(GameScene.getSliderLineEnemy().getCount() + 1);
        GameScene.getMessage().show("{RED}base_damaged");
    }
}
